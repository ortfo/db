    ...
    public static function fromAfter(?array $value): ?array {
        if (!is_null($value)) {
            return  array_map(function ($value) {
                return ExporterCommand::from($value); /*class*/
            }, $value);
        } else {
            return null;
        }
...
// This is a autogenerated file:ExporterCommand
...
class ExporterCommand {
    ...
    public function toLog(): ?array {
        if (ExporterCommand::validateLog($this->log))  {
            if (!is_null($this->log)) {
                return array_map(function ($value) {
                    return $value; /*string*/
                }, $this->log);
        ...
        throw new Exception('never get to this ExporterCommand::log');
    }
    ...
    public static function validateLog(?array $value): bool {
        if (!is_null($value)) {
            if (!is_array($value)) {
                throw new Exception("Attribute Error:ExporterCommand::log");
            }
            array_walk($value, function($value_v) {
                if (!is_string($value_v)) {
                    throw new Exception("Attribute Error:ExporterCommand::log");
    ...
    public function getLog(): ?array {
        ...
        throw new Exception('never get to getLog ExporterCommand::log');
    }
    ...
    public function toRun(): ?string {
        if (ExporterCommand::validateRun($this->run))  {
            if (!is_null($this->run)) {
        ...
        throw new Exception('never get to this ExporterCommand::run');
    }
    ...
    public static function validateRun(?string $value): bool {
        if (!is_null($value)) {
            if (!is_string($value)) {
                throw new Exception("Attribute Error:ExporterCommand::run");
            }
        }
        return true;
    }
    ...
    public function getRun(): ?string {
        ...
        throw new Exception('never get to getRun ExporterCommand::run');
    }
    ...
    public static function sampleRun(): ?string {
        return 'ExporterCommand::run::32'; /*32:run*/
    }
     ...
     */
    public function validate(): bool {
        return ExporterCommand::validateLog($this->log)
        || ExporterCommand::validateRun($this->run);
    }
     ...
     * @throws Exception
     */
    public static function from(stdClass $obj): ExporterCommand {
        return new ExporterCommand(
         ExporterCommand::fromLog($obj->{'log'})
        ,ExporterCommand::fromRun($obj->{'run'})
        );
    }
     ...
     * @return ExporterCommand
     */
    public static function sample(): ExporterCommand {
        return new ExporterCommand(
         ExporterCommand::sampleLog()
        ,ExporterCommand::sampleRun()
        );
    }
}
