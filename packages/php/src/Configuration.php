...
class Configuration {
    private ?string $buildMetadataFile; // json:build metadata file Optional
    ...
    /**
     * @param string|null $buildMetadataFile
    ...
    public function toBuildMetadataFile(): ?string {
        if (Configuration::validateBuildMetadataFile($this->buildMetadataFile))  {
            if (!is_null($this->buildMetadataFile)) {
    ...
    public static function sampleExtractColors(): ?ExtractColorsConfiguration {
        return ExtractColorsConfiguration::sample(); /*33:extractColors*/
    }
    ...
    public static function sampleMakeGifs(): ?MakeGIFSConfiguration {
        return MakeGIFSConfiguration::sample(); /*34:makeGifs*/
    }
    ...
    public static function sampleMakeThumbnails(): ?MakeThumbnailsConfiguration {
        return MakeThumbnailsConfiguration::sample(); /*35:makeThumbnails*/
    }
    ...
    public static function sampleMedia(): ?MediaConfiguration {
        return MediaConfiguration::sample(); /*36:media*/
    }
    ...
    public static function sampleTags(): ?TagsConfiguration {
        return TagsConfiguration::sample(); /*39:tags*/
    }
    ...
    public static function sampleTechnologies(): ?TechnologiesConfiguration {
        return TechnologiesConfiguration::sample(); /*40:technologies*/
    }
