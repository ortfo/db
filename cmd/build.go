...
func init() {
	...
	buildCmd.PersistentFlags().IntVar(&flags.WorkersCount, "workers", runtime.NumCPU(), "Choose the number of workers to build the database. Defaults to the number of CPU cores.")
